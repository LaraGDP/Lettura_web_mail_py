...
to = gmail_user;
subject = 'Cambio stato pagina COVID-19'
email_text = 'E'' cambiato qualcosa nella pagina https://prenotavaccino.sanita.toscana.it/#/home.\n Vai a controllare!'

BODY = '\r\n'.join(['To: %s' % to, 'From: %s' % gmail_user,'Subject: %s' % subject,'', email_text])

# url to be scraped
url = "https://prenotavaccino.sanita.toscana.it/#/home"
